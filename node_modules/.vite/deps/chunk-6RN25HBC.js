...
function useVisualElement(Component2, visualState, props, createVisualElement2) {
  ...
  const useAnimateChangesEffect = window.HandoffAppearAnimations ? useIsomorphicLayoutEffect : import_react7.useEffect;
...
function getValidChildren(children) {
  return import_react45.Children.toArray(children).filter(
    (child) => (0, import_react45.isValidElement)(child)
  );
}
...
//# sourceMappingURL=chunk-6RN25HBC.js.map
