...
export declare const IndicatorSeparator: <Option, IsMulti extends boolean, Group extends GroupBase<Option>>(props: IndicatorSeparatorProps<Option, IsMulti, Group>) => React.JSX.Element;
/**
 ...
 */
export declare const DownChevron: (props: IconProps) => React.JSX.Element;
 ...
 */
export declare const CrossIcon: (props: IconProps) => React.JSX.Element;
